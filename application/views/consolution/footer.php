          ...
          <div class="col-md-6 col-lg-3">
            <div class="ftco-footer-widget mb-5">
              ...
              <div class="block-21 mb-4 d-flex">
                <a class="blog-img mr-4" style="background-image: url(<?php echo assets_url('images/image_1.jpg');?>);"></a>
                <div class="text">
              ...
              <div class="block-21 mb-5 d-flex">
                <a class="blog-img mr-4" style="background-image: url(<?php echo assets_url('images/image_2.jpg');?>);"></a>
                <div class="text">
                  <h3 class="heading"><a href="#">Even the all-powerful Pointing has no control about</a></h3>
                  <div class="meta">
                    <div><a href="#"><span class="icon-calendar"></span> June 27, 2019</a></div>
  ...
  <script src="<?php echo assets_url('js/bootstrap-datepicker.min.js');?>"></script>
  ...
  $(document).ready(function(){
      $('#jemaat').DataTable({
          ...
          "ajax": {
              "url": "<?php echo base_url('jemaat/getLists/'); ?>",
              "type": "POST"
          },
