                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6 col-lg-3">
                        <div class="single-footer-widget mb-70">
                            <a href="#" class="footer-logo"><img src="<?php echo assets_url('img/core-img/logo2.png') ?>" alt=""></a>
                    ...
                    <div class="col-12 col-sm-6 col-lg-3">
                        <div class="single-footer-widget mb-70">
                            ...
                            <div class="contact-information">
                                <p><i class="fa fa-map-marker" aria-hidden="true"></i> Jl. Pertanian Wosi, Manokwari, Papua Barat 98312</p>
                                <a href="callto:001-1234-88888"><i class="fa fa-phone" aria-hidden="true"></i> (0986) 215608</a>
                                <a href="mailto:info.deercreative@gmail.com"><i class="fa fa-envelope" aria-hidden="true"></i> gki_efratawosi@gmail.com</a>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
    ...
    <!-- Popper js -->
    <script src="<?php echo assets_url('js/bootstrap/popper.min.js') ?>"></script>
    <!-- Bootstrap js -->
