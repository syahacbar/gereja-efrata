...
?> 
            ...
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col-12 col-lg-6">
                    <div class="about-thumbnail">
                        <img src="<?php echo assets_url('img/bg-img/26.jpg');?>" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="call-to-action-area section-padding-100 bg-img bg-overlay" style="background-image: url(<?php echo assets_url('img/bg-img/6.jpg');?>)">
        <div class="container">
            <div class="row">
                <div class="col-12">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-why-choose-us mb-100">
                        <img src="<?php echo assets_url('img/core-img/why1.png');?>" alt="">
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-why-choose-us mb-100">
                        <img src="<?php echo assets_url('img/core-img/why2.png');?>" alt="">
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-why-choose-us mb-100">
                        <img src="<?php echo assets_url('img/core-img/why3.png');?>" alt="">
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-team-members text-center mb-100">
                        <div class="team-thumb" style="background-image: url(<?php echo assets_url('img/bg-img/33.jpg');?>);">
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-team-members text-center mb-100">
                        <div class="team-thumb" style="background-image: url(<?php echo assets_url('img/bg-img/34.jpg');?>);">
                            <div class="team-social-info">
                                <a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                                <a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a>
                                <a href="#"><i class="fa fa-linkedin" aria-hidden="true"></i></a>
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-team-members text-center mb-100">
                        <div class="team-thumb" style="background-image: url(<?php echo assets_url('img/bg-img/35.jpg');?>);">
                            <div class="team-social-info">
                                <a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                                <a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a>
                                <a href="#"><i class="fa fa-linkedin" aria-hidden="true"></i></a>
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-team-members text-center mb-100">
                        <div class="team-thumb" style="background-image: url(<?php echo assets_url('img/bg-img/36.jpg');?>);">
                            <div class="team-social-info">
                                <a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                                <a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a>
                                <a href="#"><i class="fa fa-linkedin" aria-hidden="true"></i></a>
